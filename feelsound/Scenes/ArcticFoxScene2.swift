...
class ArcticFoxScene2: SKScene {
    ...
    private var foxNode: SKSpriteNode!
        ...
        private func loadTextures() {
            ...
            restTexture = SKTexture(imageNamed: "휴식_6")
        }
        ...
        private func addSubtleFloatAnimation() {
            ...
            foxNode?.run(floatForever, withKey: "float")
        }
        ...
        private func enterRestingState() {
            ...
            foxNode.run(SKAction.repeat(blink, count: 3))
